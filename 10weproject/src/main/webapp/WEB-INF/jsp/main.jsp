...
<body class="layui-layout-body">
	<div class="layui-layout layui-layout-admin">
		<ul class="layui-nav layui-bg-green">
			<li class="layui-nav-item"><a href="">医院管理系统</a></li>
			<li class="layui-nav-item layui-this"><a href="">首页</a></li>
			<li class="layui-nav-item"><a href="">健康小知识</a></li>
			<li class="layui-nav-item"><a href="">均衡饮食</a></li>
		</ul>
						...
						<div class="layui-collapse" lay-accordion="">
							...
							<div class="layui-collapse" lay-accordion="">
								<div class="layui-colla-item">
									...
									<div class="layui-colla-content">
										<p>针灸科
											古代医学分科名。针灸疗法由来已久，唐代始设针科，宋代设针兼灸科，元、明两代均设有针灸科，清朝前期也设针灸科，道光二年（公元1822年）太医院中取消针灸科。</p>
									</div>
								</div>
								<div class="layui-colla-item">
...
<div style="display: none;" id="editDiv">
	<form class="layui-form" id="editForm" lay-filter="editForm" action="">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="stadate" autocomplete="off"
					class="layui-input" id="stadateInput">
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="enddate" autocomplete="off"
					class="layui-input" id="enddateInput">
			</div>
		</div>
